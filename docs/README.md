...
| 文档 | 说明 |
| --- | --- |
| [porting-jlaffaye-ftp.md](./porting-jlaffaye-ftp.md) | **总体方案**：将 Go 项目 [jlaffaye/ftp](https://github.com/jlaffaye/ftp) 移植到 MoonBit。上游源码分析（1780 行实现 / 6 文件）、功能矩阵、协议实现要点、依赖选型、分层包结构、分阶段计划、测试策略、许可证合规与风险应对 |
| [porting/](./porting/) | **实施文档集**：可执行的移植步骤拆解。W0–W8 九个工作包、上游文件级落点映射、API 映射表、测试策略、9 条兼容性落地清单、风险与估算、验收标准 |
| [proposal.md](./proposal.md) | 项目申报书：项目价值与生态定位、使用场景、核心功能范围与边界、实现路径与技术理解 |
